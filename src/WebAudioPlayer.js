 ...
 */
 export const init = async (player, audio = null) => {
	_PLAYERROOT		= player;
...
function getNodeByClass(context, className) {
    return document.querySelector(`#${context.id} ${className}`);
}
...
function _setUpFunctionality(context) {
	_PLAYER_FUNCS.ajaxSpinner = {
		node: getNodeByClass(context, _PLAYER_PARTS_SELECTORS.ajaxSpinner),
	...
	_PLAYER_FUNCS.autoplayBtn = {
		node: getNodeByClass(context, _PLAYER_PARTS_SELECTORS.autoplayBtn),
	...
	_PLAYER_FUNCS.currentTimeDisplay = getNodeByClass(context, _PLAYER_PARTS_SELECTORS.currentTimeDisplay);
	_PLAYER_FUNCS.infoButton = {
		node: getNodeByClass(context, _PLAYER_PARTS_SELECTORS.infoButton),
	...
	_PLAYER_FUNCS.infoScreen = {
		node: getNodeByClass(context, _PLAYER_PARTS_SELECTORS.infoScreen),
		close: function(fast) {
			if (fast) {
	...
	_PLAYER_FUNCS.infoScroll = getNodeByClass(context, _PLAYER_PARTS_SELECTORS.infoScroll);
	_PLAYER_FUNCS.infoScrollContent = getNodeByClass(context, _PLAYER_PARTS_SELECTORS.infoScrollContent);
	_PLAYER_FUNCS.loadProgress = {
		node: getNodeByClass(context, _PLAYER_PARTS_SELECTORS.loadProgress),
		reset: function() {
	...
	_PLAYER_FUNCS.muteButton = {
		node: getNodeByClass(context, _PLAYER_PARTS_SELECTORS.muteButton)
	}
	_PLAYER_FUNCS.nextTrackBtn = {
		node: getNodeByClass(context, _PLAYER_PARTS_SELECTORS.nextTrackBtn),
		handleButton: function(e) {
	...
	_PLAYER_FUNCS.playBtn = {
		node: getNodeByClass(context, _PLAYER_PARTS_SELECTORS.playBtn),
		handleButton: function(e) {
	...
	_PLAYER_FUNCS.playlistBox = getNodeByClass(context, _PLAYER_PARTS_SELECTORS.playlistBox);
	_PLAYER_FUNCS.playlistBtn = {
		node: getNodeByClass(context, _PLAYER_PARTS_SELECTORS.playlistBtn),
		handleButton: _loadAllPlaylistsHandler
	}
	_PLAYER_FUNCS.prevTrackBtn = {
		node: getNodeByClass(context, _PLAYER_PARTS_SELECTORS.prevTrackBtn),
	...
	_PLAYER_FUNCS.remainingTime = getNodeByClass(context, _PLAYER_PARTS_SELECTORS.remainingTime);
	_PLAYER_FUNCS.seekHandleBox = {
		node: getNodeByClass(context, _PLAYER_PARTS_SELECTORS.seekHandleBox),
	...
	_PLAYER_FUNCS.screenTitle = getNodeByClass(context, _PLAYER_PARTS_SELECTORS.screenTitle);
	_PLAYER_FUNCS.userScreen = {
		node: getNodeByClass(context, _PLAYER_PARTS_SELECTORS.userScreen),
		reset: function() {
	...
	_PLAYER_FUNCS.volumeButton = {
		node: getNodeByClass(context, _PLAYER_PARTS_SELECTORS.volumeButton),
	...
	_PLAYER_FUNCS.volumeSliderMute = {
		node: getNodeByClass(context, _PLAYER_PARTS_SELECTORS.volumeSliderMute),
		close: function() {
	...
	_PLAYER_FUNCS.volumeSlider = {
		node: getNodeByClass(context, _PLAYER_PARTS_SELECTORS.volumeSlider),
		handleInput: function(e) {
...
function _checkMimeSupport() {
	...
	for (let x in _AUDIO_CODECS_MIMES) {
        for (let xx in _AUDIO_CODECS_MIMES[x]) {
            ans = canPlayType(_AUDIO_CODECS_MIMES[x][xx]);
...
function _handleLoadTrack(e) {
	_removePlayingClassFromAll();
	_loadTrack(parseInt(e.target.getAttribute('data-tracknum')));
}
